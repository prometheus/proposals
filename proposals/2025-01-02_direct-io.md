...
During development, this effort will be gated behind a feature flag (likely `use-direct-io`).
Enabling this flag will activate direct I/O where appropriate to address the concerns outlined
in the [Why](#why) section.
...
during compaction (behind `use-direct-io`): <https://github.com/prometheus/prometheus/pull/15365>
